pipeline {
    ...
    parameters {
        ...
        string(name: 'STUDENT_NAME', defaultValue: 'Manahil Fatima', description: 'Your name')
    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                echo "Pipeline executed by student: ${params.STUDENT_NAME}"
                sh '''
    ...
    post {
        ...
        success {
            echo "Pipeline succeeded! Version ${APP_VERSION} built and tested by ${params.STUDENT_NAME}."
        }
        failure {
